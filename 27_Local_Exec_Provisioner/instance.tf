...
provisioner "local-exec" {
  working_dir = "/home/mangesh/Documents/Project/terraform_script/27_Local_Exec_Provisioner"
  command = "echo ${aws_instance.EC2UsingTerraform.public_ip} >> instance_public_ip.txt"
}
